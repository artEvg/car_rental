		...
		<motion.div
			...
			<div className='text-white'>
				<h2 className='text-3xl font-medium'>
					У вас есть Роскошный Автомобиль?
				</h2>
				<p className='mt-2'>
					Зарабатывайте на аренде своего автомобиля с CarRental.
				</p>
				<p className='max-w-130'>
					Мы берём на себя страхование, проверку водителей и безопасные платежи,
					чтобы вы могли получать пассивный доход без лишних хлопот.
				</p>
				<motion.button
